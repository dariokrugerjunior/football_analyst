...
class SpeedAndDistanceEstimator():
    ...
    def add_speed_and_distance_to_tracks(self, tracks):
        ...
        for object, object_track in tracks.items():
            if object == "ball" or object == "refeerees":
                continue
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_track[frame_num].items():
                    if track_id not in object_track:
                        continue

                    start_position = object_track[frame_num][track_id]['position_transformed']
                    end_position = object_track[frame_num][track_id]['position_transformed']
                    ...
                    speed_km = speed_meteres_per_second * 3.6
